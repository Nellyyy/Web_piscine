...
<body>
  ...
  <?php
    ...
    $vet="livre";
    if($db_found){
    $sql = "SELECT * FROM `item` WHERE `item_type` LIKE '%$vet%'AND `item_categorie` LIKE 'magazine' AND NOT `utilisateur_email` LIKE '$email'"; 
